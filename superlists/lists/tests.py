...
class HomePageTest(TestCase):
    ...
    def test_root_url_resolves_tom_home_page_views(self):
        found = resolve('/')
...
# Adjust model so that items are associated with different lists DONE
# Add unique URLS for each list DONE
